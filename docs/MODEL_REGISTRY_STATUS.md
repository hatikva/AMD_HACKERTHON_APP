...
| `nemotron-3-nano:4b` | selected for Version 5 Ollama runtime | GGUF observed in the Ollama backup store, size `2,837,586,496` bytes, SHA-256 `527db2cf6c705d8fabb95693d038d9c06b4a2b0b8b0a4bbdbd01212d37242970`; runtime-certified through `version5-ollama`, but not yet `LOCAL_CERTIFIED` for any jurisdiction. |
